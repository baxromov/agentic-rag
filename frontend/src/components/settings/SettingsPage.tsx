    ...
    <div className="h-full overflow-auto bg-gradient-to-br from-slate-50 to-slate-100">
      <div className="p-8">
        <div className="mb-8">
          ...
          <p className="text-slate-600">Manage your system preferences</p>
        </div>
        ...
        <div className="grid grid-cols-1 gap-6">
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-slate-200 p-6">
            ...
            <div className="space-y-4">
              <button className="w-full px-4 py-3 bg-slate-100 hover:bg-slate-200 text-slate-900 rounded-lg transition-colors text-left font-medium">
                Change Password
              </button>
              <button className="w-full px-4 py-3 bg-slate-100 hover:bg-slate-200 text-slate-900 rounded-lg transition-colors text-left font-medium">
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-slate-200 p-6">
            ...
            <div className="space-y-3 text-sm">
              <div className="flex justify-between py-2 border-b border-slate-100">
                ...
                <span className="font-medium text-slate-900">2.0.0</span>
              </div>
              <div className="flex justify-between py-2 border-b border-slate-100">
                <span className="text-slate-600">Last Updated</span>
                <span className="font-medium text-slate-900">Feb 14, 2026</span>
              </div>
